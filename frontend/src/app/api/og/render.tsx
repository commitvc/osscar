...
type RenderOptions = {
  /** Quarter label, e.g. "Q1 2026" — rendered in the top pill and body copy. */
  quarterLabel: string;
  /** Extra response headers (Cache-Control, Content-Disposition, …). */
  headers?: Record<string, string>;
};

export async function renderShareCard(
  org: OrgCardData,
  { quarterLabel, headers }: RenderOptions,
  ...
  // Static assets (inline as data URLs — ImageResponse can't fetch at runtime).
  ...
  const rankFontSize = isTop ? (rankLabel.length >= 3 ? 150 : 170) : 180;

  const starsDelta = formatDelta(org.github_stars_start, org.github_stars_end);
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Ranked among the fastest-growing open source organizations of {quarterLabel}
            </span>
          </div>
